...
- spot_smc_controller/spot_smc_one_leg_final.py : Task 4 - SMC 1 leg (FL)
...
## Requirements
- Ubuntu 22.04, ROS2 Jazzy, Webots R2025a, Python 3.10+, numpy

## Run
    python3 spot_smc_controller/spot_smc_one_leg_final.py
    python3 spot_smc_controller/spot_smc_4legs.py
